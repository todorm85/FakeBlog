# XSSPress blog app
XSSPress is a simple blogging web application.
...
## SetUp
You must open a web browser to set up your project after it is hosted on IIS. You will be prompted to create the administrator user when you first run the app.
